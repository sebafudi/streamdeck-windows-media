...
if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Media_Control.d.js)'))) {
  module.exports = require('./NodeRT_Windows_Media_Control.d.js');
} else {
  module.exports = require('../build/Release/binding.node');
}

var externalReferencedNamespaces = ['Windows.Media', 'Windows.Storage.Streams'];
